                        ...
                        <div class="about-banner-img row">
                            <div class="col-lg-4">
                                <div class="single-img img-hover-effect">
                                    <img class="img-full" src="/tromic/assets/images/about/banner/1-1-400x500.jpg" alt="About Banner">
                                </div>
                            </div>
                            <div class="col-lg-4 section-space-top-100">
                                <div class="single-img img-hover-effect">
                                    <img class="img-full" src="/tromic/assets/images/about/banner/1-2-400x500.jpg" alt="About Banner">
                                </div>
                            </div>
                            <div class="col-lg-4 section-space-top-100 pt-lg-0">
                                <div class="single-img img-hover-effect">
                                    <img class="img-full" src="/tromic/assets/images/about/banner/1-3-400x500.jpg" alt="About Banner">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="team-member-item img-gradient-effect">
                                        <div class="team-member-img">
                                            <a href="#">
                                                <img class="img-full" src="/tromic/assets/images/about/team/1-1-400x442.jpg" alt="Team Member">
                                            </a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="team-member-item img-gradient-effect">
                                        <div class="team-member-img">
                                            <a href="#">
                                                <img class="img-full" src="/tromic/assets/images/about/team/1-2-400x442.jpg" alt="Team Member">
                                            </a>
                                        </div>
                                        <div class="team-member-content">
                                            <h2 class="title mb-0">Jaren Hammer</h2>
                                ...
                                <div class="swiper-slide">
                                    <div class="team-member-item img-gradient-effect">
                                        <div class="team-member-img">
                                            <a href="#">
                                                <img class="img-full" src="/tromic/assets/images/about/team/1-3-400x442.jpg" alt="Team Member">
                                            </a>
                                        </div>
                                        <div class="team-member-content">
                                            <h2 class="title mb-0">Jaren Hammer</h2>
