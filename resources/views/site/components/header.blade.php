                ...
                <div class="col-lg-12">
                    <div class="header-middle-wrap position-relative">
                        ...
                        <a href="{{route('admin.dashboard')}}" class="header-logo">
                            <img rel='preload' width="298px" height="167px" src="{{asset('assets/site/images/logos-mascote/logo_h_vermelho.png')}}" alt="Header Logo">
                        </a>
                ...
                <ul class="minicart-list">
                    <li class="minicart-product">
                        ...
                        <a href="shop.html" class="product-item_img">
                            <img class="img-full" src="/tromic/assets/images/product/small-size/1-1-70x70.png" alt="Product Image">
                        </a>
                    ...
                    <li class="minicart-product">
                        ...
                        class="pe-7s-trash" data-tippy="Wanna Remove?" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme="sharpborder"></i></a>
                        <a href="shop.html" class="product-item_img">
                            <img class="img-full" src="/tromic/assets/images/product/small-size/1-2-70x70.png" alt="Product Image">
                        </a>
                        <div class="product-item_content">
                    ...
                    <li class="minicart-product">
                        ...
                        <a href="shop.html" class="product-item_img">
                            <img class="img-full" src="/tromic/assets/images/product/small-size/1-3-70x70.png" alt="Product Image">
                        </a>
                        <div class="product-item_content">
                    ...
                    <li class="minicart-product">
                        ...
                        <a href="shop.html" class="product-item_img">
                            <img class="img-full" src="/tromic/assets/images/product/small-size/1-4-70x70.png" alt="Product Image">
                        </a>
                        <div class="product-item_content">
                    ...
                    <li class="minicart-product">
                        ...
                        <a href="shop.html" class="product-item_img">
                            <img class="img-full" src="/tromic/assets/images/product/small-size/1-5-70x70.png" alt="Product Image">
                        </a>
                        <div class="product-item_content">
...
<script defer>
    let sandw = document.querySelector('.sandwich')
    let sidebar = document.querySelector('.sidebar')
    sandw.addEventListener(('click'), () =>{
